...
import { Layout, Menu, Button, message, Avatar, Dropdown, Select, Progress } from 'antd';
...
import { DictionaryIcon, 
  // CorpusIcon,
   TrainIcon, LabelIcon,
    // VisualIcon, CreateIcon, PersonIcon, ProjectIcon 
  } from './Icon';
      ...
      <Layout style={{
        ...
        <Sider trigger={null} theme="light">
          ...
          <Menu theme="light" mode="inline" openKeys={openKeys} selectedKeys={selectedKeys}>
            ...
            <SubMenu key="text" title="语料数据" 
            // icon={<Icon component={CorpusIcon}></Icon>}
            >
            </SubMenu>
            ...
            <Menu.Item key={'label'} icon={<Icon component={LabelIcon}></Icon>} onClick={
              () => {
            ...
            // icon={<Icon component={VisualIcon}></Icon>}
             onClick={
              () => {
          ...
          >
            <div style={{ width: '75%', height: '96%', marginTop: '1%', marginLeft: '1%', background: 'white', float: 'left' }}>
              <Menu mode="horizontal" style={{ fontSize: '1em', width: '100%', color: 'white', backgroundColor: 'rgb(120,166,234)' }}>
                ...
                <div style={{ paddingLeft: "59%" }}>
                  <Button style={buttonStyle} icon={<UploadOutlined />} onClick={
                    () => {
                  ...
                  <Button style={buttonStyle} icon={<PlayCircleOutlined />} onClick={
                    () => {
                      // setLoadingState(true)
                      // identifyEntity()
                      // ipcRenderer.send(OPEN_MODEL_CONFIG_WINDOW)
            ...
            <div style={{ width: '22%', height: '100%', marginLeft: '1%', background: 'white', float: 'left' }}>
              <div style={{ marginTop: '100%' }}>
                <h1 style={{ marginLeft: '5%' }}>当前个人完成进度：</h1>
                <Progress percent={50} status="active" style={{ marginTop: '10%', width: '80%', marginLeft: '10%' }} />
              </div>
              <div style={{ marginTop: '20%' }}>
                <h1 style={{ marginLeft: '5%' }}>当前项目完成进度：</h1>

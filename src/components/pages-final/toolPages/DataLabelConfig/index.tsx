...
import { Button, Radio, Select, Space, Table, Input } from 'antd'
        ...
        >
          ...
          >
            <div>
              ...
              >
                <span className="YuLiaoPeiZhi-text" style={{ float: 'left', marginTop: '0.5%' }}>新增标签名</span>
                {/* <input className="YuLiaoPeiZhi-input" type="text" style={{ marginLeft: '20px' }} placeholder="新增标签"></input>
                &nbsp;&nbsp;&nbsp;&nbsp; */}
                <Input style={{ width: '10%', marginLeft: '3%', marginRight: '3%', float: 'left' }} placeholder="新增标签" />
                <span className="YuLiaoPeiZhi-text" style={{ float: 'left', marginTop: '0.5%' }}>新增标签颜色</span>
                <Select defaultValue="doc2vec" style={{ width: '12%', float: 'left', marginLeft: '3%' }}>
                  <Option value="doc2vec">red</Option>
                  <Option value="2017">skyblue</Option>
                  <Option value="2017">yellow</Option>
                </Select>
                <Button style={{ marginLeft: '5%', borderRadius: '5px', width: '80px', backgroundColor: 'rgb(0,68,107)', border: 'rgb(0,68,107)', color: 'white' }}>新增</Button>
